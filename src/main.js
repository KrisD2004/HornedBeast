...
// The main component displays a collection of "Horned beasts" using the "Horned Beasts" component and data 
...
function Main(props) {
    // The state hook is used to manage the selected number of horns to filter the beasts by.
